...
public final class AudioHelper {
    ...
    public static InputStream GetAudio(String text) throws Exception {
        if (!isInitialized) {
            throw new Exception();
        }
        ...
        return Combine(toCombine, toCombineLengths);
    }
    ...
    private static InputStream Combine(InputStream[] streams, Long[] lengths) throws IOException {
        long length = 0;
